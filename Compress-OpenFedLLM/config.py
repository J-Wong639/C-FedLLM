...
def save_config(script_args, fed_args):
    ...
    while True:
        if not os.path.exists(output_dir):
            ...
            output_dir = f"{script_args.output_dir}/{dataset_name_split}_{fed_args.fed_alg}_c{fed_args.num_clients}s{fed_args.sample_clients}_i{script_args.max_steps}_b{script_args.batch_size}a{script_args.gradient_accumulation_steps}_l{script_args.seq_length}_qlevel{fed_args.quantize_level}_{fed_args.test_dataset}_{script_args.special_sign}_{now_time}"
